...
Zunächst muss das die Library simpy installiert werden, welches die eigentliche Simulation ausführt. 
...
Label(text="Defekt", width=20, height=1, bg="darkgrey", font=Überschrift2).grid(row=8, column=5)
...
print("Die Fahrzeuge fahren im Schnitt %d Teilumläufe am Tag."
      " Das Maximum ist %d und das Minimum %d." % (round(sum(numTU_proF) / len(numTU_proF)), max(numTU_proF), min(numTU_proF)))
...
# Abfrage, ob Fahrtzeit über Simulationsdauer
