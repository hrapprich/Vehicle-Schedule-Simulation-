...
## Prio 2: GUI optisch und inhaltlich verbessern (mehrere Dateien als Auswahlmöglichkeit)
    ## Prio 1: Stau einfügen --> Erster Aufschlag implementiert
## Prio 1: Mehr und validere Verspätungsarten
## Prio 1: Modularität ausbauen
    ## Prio 1: Dem Output die Verspätungsart hinzufügen --> Erster Aufschlag implementiert
## Prio 2: Einleseroutine hinzufügen
## Prio 3: Dateninkonsistenzen beseitigen
## Prio 2: KPIs

## Zu klären:
## Statt mit absoluten Verspätungen lieber mit relativen Verspätungen arbeiten?
...
button = Button(text = "Bestätigen", bg = "green", font = "Times", command = root.destroy)
...
print("vehID Teilumlaufnummer Standort Dep/Arr Uhrzeit(Soll) Uhrzeit(Ist) Fahrtverspätung Gesamtverspätung Verspätungsursache",
                ...
                while umlaufstatus == 1:  # while Fahrzeug im Umlauf
                    for fahrtnummer in range(0, len(FromHS_dic[vehID][teilumlaufnummer])):
                        ...
                        if ElementID_dic[vehID][teilumlaufnummer][fahrtnummer] == 9:
                            ...
                            # Füge der Outputvariable "delayType" den Grund der Verspätung hinzu
