...
label1 = Label(Frame1, text="Globale Störungsgeneratoren", width = 50, height = 1, bg = "grey", font = Überschrift).grid(row=5)
label2 = Label(Frame2, text="Selektive Störungsgeneratoren", width = 50, height = 1, bg = "grey", font = Überschrift).grid(row=12)
label4 = Label(text="Wetter", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=6, column = 5)
label5 = Label(text="Fahrerausfall", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=9, column = 2)
label6 = Label(text="Defekt", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=9, column = 5)
label7 = Label(text="Veranstaltung", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=13, column = 2)
label8 = Label(text="Unfall", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=15, column = 2)
label9 = Label(text="Baustelle", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=17, column = 2)
label10 = Label(text="Sonstige Streiks", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=19, column = 2)
label11 = Label(text="Defekt", width = 20, height = 1, bg = "darkgrey", font = Überschrift2).grid(row=22, column = 2)


button = Button(text = "Bestätigen", bg = "green", width = 20, height = 1, font = Bestätigung, command = root.destroy)
button.grid(row = 25, column = 0, columnspan=5, sticky = S+W)


dropdown = StringVar(root)
dropdown.set("Arbeitstag - Keine Ferien") # default value

day = OptionMenu(root, dropdown, "Arbeitstag - Keine Ferien", "Arbeitstag Ferien", "Samstag", "Sonntag")
day.grid(row = 1, column = 2, columnspan=5, sticky=W)
...
Checkbutton9.grid(row = 7, column = 5, columnspan=7, sticky=W)

varRegen = IntVar()
Checkbutton10 = Checkbutton(root, text = "Regen", font = Text, variable = varRegen)
Checkbutton10.grid(row = 8, column = 5, columnspan=7, sticky=W)

varDefekt = IntVar()
Checkbutton11 = Checkbutton(root, text = "Fahrzeugdefekt im Depot", font = Text, variable = varDefekt)
Checkbutton11.grid(row = 10, column = 5, columnspan=7, sticky=W)

###Lokale Störungsmuster
...
varDefekt = StringVar()
Entry(root,textvariable=varDefekt).grid(row=23, column=5, sticky = W)
...
if varBaustelle.get() != (""):
    baustellenHS = varBaustelle.get().split(', ')
    for i in range(len(baustellenHS)):
        baustellenHS[i] = int(baustellenHS[i])
